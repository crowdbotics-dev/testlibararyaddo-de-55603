...
## Project Structure
    ...
    ├── testlibararyaddo_de_55603  # Django project configurations
...
1. Clone this repo and `cd testlibararyaddo_de_55603`
...
2. Clone this repo and `cd testlibararyaddo_de_55603`
